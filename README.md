...
> Trigen is under active development. The full runtime requires LLM API configuration.
...
Trigen is licensed under the MIT License. See [LICENSE](./LICENSE) for details.
