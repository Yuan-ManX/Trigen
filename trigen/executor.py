...
# The set of tools that may execute in parallel within a single batch. The
# canonical definition lives in trigen.planner so a new tool is registered in
# exactly one place and can never drift between the planner and the executor.
from trigen.planner import _PARALLEL_SAFE_TOOLS
