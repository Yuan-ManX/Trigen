...
export const TEMPLATES: TemplateCard[] = [
  ...
  // ----- Direct-prompt templates (no skill required; driven by intent parser) -----
  {
    id: 'pyramid_field',
    name: 'Pyramid Field',
    description: 'Grid of varied pyramids on a sand plane, low sun, long shadows',
    icon: Pyramid,
    color: 'text-amber-300',
    prompt: 'Create a pyramid field: 9 pyramids of varying heights arranged in a 3x3 grid on a sand-colored plane, with a low warm sun light casting long shadows',
    objects: '9 pyramids + ground plane',
  },
  {
    id: 'neon_stage',
    name: 'Neon Stage',
    description: 'Dark stage with neon-rimmed pedestal, magenta and cyan rim lights, fog',
    icon: Music,
    color: 'text-fuchsia-400',
    prompt: 'Create a neon stage scene: a dark reflective floor, a pedestal with neon-rimmed edges, two point lights (one magenta from the left, one cyan from the right), and a low-density fog',
    objects: 'Pedestal + floor + 2 lights',
  },
  {
    id: 'constellation',
    name: 'Constellation',
    description: 'Star field on a black sky with named star markers and connecting lines',
    icon: Star,
    color: 'text-yellow-200',
    prompt: 'Create a constellation scene: 40 small glowing sphere stars on a black background, with 6 brighter named stars carrying annotations labeled Alpha, Beta, Gamma, Delta, Epsilon, Zeta',
    objects: '40 stars + 6 annotations',
  },
  {
    id: 'rocket_launch',
    name: 'Rocket Launch',
    description: 'Sleek rocket on a launch pad with smoke plume and ground lights',
    icon: Rocket,
    color: 'text-rose-400',
    prompt: 'Create a rocket launch scene: a tall cylinder rocket with a cone nose and four fin boxes on a metal launch pad, a sphere smoke plume at the base, and three warm ground spotlights',
    objects: 'Rocket + pad + plume + 3 lights',
  },
  {
    id: 'pinned_demo',
    name: 'Annotated Showcase',
    description: 'Pedestal with three primitives, each carrying a labeled annotation pin',
    icon: Pin,
    color: 'text-accent-emerald',
    prompt: 'Create an annotated showcase: a pedestal with a red sphere, a blue box, and a green torus arranged on top, plus three annotations labeled Sphere, Cube, and Torus anchored to each object',
    objects: 'Pedestal + 3 primitives + 3 annotations',
  },
  {
    id: 'terminal_grey',
    name: 'Monochrome Studio',
    description: 'All-grey subject on a grey backdrop with a single soft key light',
    icon: Terminal,
    color: 'text-zinc-300',
    prompt: 'Create a monochrome studio: a grey torus knot on a grey pedestal, a grey backdrop plane, and a single soft area key light from the front-left',
    objects: 'Subject + pedestal + backdrop + key light',
  },
  {
    id: 'clear',
    name: 'Empty Scene',
